...
! function(e, t) {
        ...
        let r, i = e.querySelector(`.${s}`),
            a = document.createTreeWalker(e, NodeFilter.SHOW_ALL, {
                acceptNode: e => {
                    ...
                    return e.classList?.contains(s) ? NodeFilter.FILTER_REJECT : NodeFilter.FILTER_ACCEPT
                }
            }),
            o = [];
        for (; r = a.nextNode();) r.originalParent || (r.originalParent = r.parentNode), o.push(r);
    ...
    let L = e => new Promise((t => {
        ...
        D = ({
            ...
            let r = e.animate(t, n);
            return r.pause(), r.id = e.dataset.tiAnimationId, L((() => {
                L((() => {
                    r.play()
                }))
            })), r
        ...
        M = async ({
            ...
            if (o.length) return await L((async () => {
    ...
    return function(e, r = {}) {
        let L = async (e, t, n = !1) => {
            K.frozen && await new Promise((e => {
                this.unfreeze = () => {
                    K.frozen = !1, e()
                }
            })), n || await Y.beforeStep(this), await ((e, t, n) => new Promise((r => {
                n.push(setTimeout((async () => {
                    await e(), r()
                }), t || 0))
            })))(e, t, W), n || await Y.afterStep(this)
        }, C = (e, t) => M({
            index: e,
            queueItems: t,
            wait: L,
        ...
        })(e, J), x = () => b(J), A = (e = 0) => function(e) {
            let {
                speed: t,
                deleteSpeed: n,
                lifeLike: r
            } = e;
            return n = null !== n ? n : t / 3, r ? [m(t, g(t)), m(n, g(n))] : [t, n]
        }(Y)[e], $ = () => (e => b(e) ? n(e.value) : d(e, !0).filter((e => !(e.childNodes.length > 0))))(J), H = (e, t) => (ee.add(e), ((e = {}) => {
            let t = e.delay;
            t && ee.add({
                delay: t
            })
            ...
            if (!x() && ne && J.appendChild(ne), te) {
                ((e, t) => {
                    let n = `[${o}='${e}'] .${s}`,
                        ...
                        i = Object.entries(P).reduce(((e, [t, n]) => `${e} ${t}: var(--ti-cursor-${t}, ${n||r[t]});`), "");
                    y(`${n} { display: inline-block; width: max-content; overflow: hidden; ${i} }`, e)
                })(Z, J), ne.dataset.tiAnimationId = Z;
                let {
                    animation: e
                } = Y.cursor, {
                    frames: t,
            ...
            try {
                ...
                if (!e) return this;
                if (K.completed = !0, await Y.afterComplete(this), !Y.loop) throw "";
                let r = Y.loopDelay;
                L((async () => {
                    await (async e => {
                        let t = O();
            ...
            var t, n, r;
            t = e, n = X, r = $(), X = Math.min(Math.max(n + t, 0), r.length), ((e, t, n) => {
                let r = t[n - 1],
                    i = v(`.${s}`, e);
        ...
        this.break = function(e) {
            ...
            let {
                instant: n
            } = t, r = F(t), i = f(e, Y.html).map((e => {
                return {
                    func: () => _(e),
                    char: e,
                    delay: n || (t = e, /<(.+)>(.*?)<\/(.+)>/.test(t.outerHTML)) ? 0 : A(),
            ...
            W.forEach(clearTimeout), W = [], w(e) && ne && I(ne), K.destroyed = !0
        }, this.freeze = function() {
            K.frozen = !0
        }, this.unfreeze = () => {}, this.reset = function(e) {
            !this.is("destroyed") && this.destroy(), e ? (ee.wipe(), e(this)) : ee.reset(), X = 0;
            for (let t in K) K[t] = !1;
            return J[x() ? "value" : "innerHTML"] = "", this
        }, this.go = function() {
            return K.started ? this : (R(), Y.waitUntilVisible ? (((e, t) => {
            ...
            })(J, z.bind(this)), this) : (z(), this))
        }, this.flush = function(e = (() => {})) {
            return R(), z(!1).then(e), this
        }, this.getQueue = () => ee, this.getOptions = () => Y, this.updateOptions = e => j(e), this.getElement = () => J;
        ...
        r.cursor = (e => {
            if ("object" == typeof e) {
                ...
                return t.animation = e.animation || {}, t.animation.frames = e.animation?.frames || n, t.animation.options = E(r, e.animation?.options || {}), t.autoPause = e.autoPause ?? u.cursor.autoPause, t.autoPauseDelay = e.autoPauseDelay || u.cursor.autoPauseDelay, t
            }
        ...
        let te = !!Y.cursor && !x(),
            ne = (() => {
                if (x()) return;
                let e = h("span");
                return e.className = s, te ? (e.innerHTML = a(Y.cursorChar).innerHTML, e) : (e.style.visibility = "hidden", e)
            })();
        Y.strings = (e => {
            let t = J.innerHTML;
            return t ? (J.innerHTML = "", Y.startDelete ? (J.innerHTML = t, i(J), k(S({
                func: Q,
                delay: A(1),
                deletable: !0
            }, $().length)), e) : t.replace(/<!--(.+?)-->/g, "").trim().split(/<br(?:\s*?)(?:\/)?>/).concat(e)) : e
        })(t(Y.strings)), Y.strings.length && q()
    }
}));
