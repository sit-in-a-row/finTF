...
corp_rel_news_path = os.path.join(current_dir, f'../../store_data/raw/crawling/corp_rel_news')
...
def corp_rel_news_info(ticker:str, year:str, start_date:str, end_date:str) -> pd.DataFrame:
    '''
    ticker, year와 시작일, 종료일을 입력하면 그에 맞춰 df 반환
    단, start_date와 end_date는 YYYYMMDD 형식으로 입력

    ex. corp_rel_news_info('005930', '2019', '20190101', '20191231')
    '''
    target_news_path = os.path.join(corp_rel_news_path, ticker, year)
